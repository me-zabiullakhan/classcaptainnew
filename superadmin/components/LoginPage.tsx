...
const AuthLayout: React.FC<{ title: string, subtitle: string, children: React.ReactNode }> = ({ title, subtitle, children }) => (
    <div className="min-h-screen flex flex-col justify-center items-center px-4 py-4 bg-gray-900 text-white">
    ...
    <div className="mb-4">
        ...
        <div className="relative">
            ...
            <input
                ...
                className="w-full bg-gray-700 text-white pl-10 pr-3 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 outline-none transition"
                {...props}
                ref={ref}
            />
        </div>
